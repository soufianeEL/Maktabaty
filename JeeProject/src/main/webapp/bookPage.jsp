	...
	<div class="container">
		<div class="row clearfix">
			...
			<div class="col-md-5 column">
				<img alt="380x440" src="<s:property value="book.image" />" width="340" height="400"> <br>
				<br>
			...
			<div class="modal fade" id="update" role="dialog"
				...
				<div class="modal-dialog">
					<s:form cssClass="modal-content" action="/book/Update.action" method="POST"
						...
						<div class="modal-body" style="text-align: center;">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<select class="form-control" name="book.auteur.idauteur" required>
										<option><s:property value="book.auteur.idauteur" /></option>
										<option>1</option>
										<option>3</option>
									</select>
								</div>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<select class="form-control" name="book.editeur.idediteur" required>
										<option><s:property value="editeur.idediteur" /></option>
										<option>2</option>
										<option>3</option>
									</select>
								</div>
			...
			<div class="modal fade" id="create" role="dialog"
				aria-labelledby="myModalLabel" aria-hidden="true">
				<div class="modal-dialog">
					<s:form cssClass="modal-content" action="/book/Create.action" method="post"
						enctype="multipart/form-data">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
								aria-hidden="true">×</button>
